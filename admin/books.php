                              ...
                              <div class="table-responsive mt-3">
                                   ...
                                   <div class="tab-content" id="myTabContent">
                                        ...
                                        <div class="tab-pane fade" id="ebooks-tab-pane">
                                             <div class="d-flex justify-content-end my-2">
                                                  <!-- Add Ebook Button -->
                                                  <a href="ebook_add.php" class="btn btn-primary"><i class="bi bi-journal-plus"></i>
                                                       Upload Book</a>
                                             </div>
                                             <div class="table-responsive">
                                                  <!-- Ebooks Table -->
...
<ul class="nav nav-tabs" id="myTab">
  <li class="nav-item">
    <button class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home-tab-pane">Home</button>
  </li>
  <li class="nav-item">
    <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile-tab-pane">Profile</button>
  </li>
  <li class="nav-item">
    <button class="nav-link" id="contact-tab" data-bs-toggle="tab" data-bs-target="#contact-tab-pane">Contact</button>
  </li>
</ul>
<div class="tab-content" id="myTabContent">
  <div class="tab-pane fade show active" id="home-tab-pane">Home Tab</div>
  <div class="tab-pane fade" id="profile-tab-pane">Profile Tab</div>
  <div class="tab-pane fade" id="contact-tab-pane">Contact Tab</div>
</div>
     </section>
</main>
<?php 
